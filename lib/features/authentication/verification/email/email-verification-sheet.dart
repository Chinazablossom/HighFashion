...
class EmailVerificationScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return  Scaffold(
      appBar: AppBar(
        leading:
          IconButton(onPressed: (){ Get.offAll(const LoginScreen(),transition: Transition.fadeIn); },
              ...
              child: Column(
                ...
                children: [
                  ...
                  TextButton(
                    ...
                    child:  Text(
                      "Resend Verification Link ${const Icon(CupertinoIcons.arrow_clockwise)}",
                      style: TextStyle(color: blueColor, fontSize: 18,fontFamily: interSemiBold),
                    ),
                  ),
