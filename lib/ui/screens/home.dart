  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      bottomNavigationBar: Obx(
            () => GNav(
            backgroundColor: isLightMode(context) ? lightWidgetColorBackground : darkWidgetColorBackground,
            ...
            const [
              ...
              GButton(icon: CupertinoIcons.heart_fill, text: "Wishlist",),
              GButton(icon: CupertinoIcons.shopping_cart, text: "Cart",   ),
