  ...
  return ThemeData.light(useMaterial3: true,).copyWith(
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
            ...
            side: const BorderSide(color: lightWidgetColorBackground,strokeAlign: 2),
            textStyle: const TextStyle(fontFamily: "InterBold",fontSize: 16,color: Colors.white,fontWeight: FontWeight.w600)
      ...
      textTheme: const TextTheme().copyWith(
        ...
        titleSmall: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black),
        labelLarge: const TextStyle().copyWith(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.black),
        labelMedium: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.black),
...
ThemeData highFashionDarkTheme() {
  return ThemeData.dark(useMaterial3: true).copyWith(
      ...
      appBarTheme: const AppBarTheme().copyWith(
        ...
        centerTitle: true,
        scrolledUnderElevation: 0,
        actionsIconTheme: const IconThemeData(color: darkWidgetColorBackground,size: 40),
        iconTheme: const IconThemeData(color: darkWidgetColorBackground,size: 40),
        titleTextStyle: const TextStyle(fontSize: 18,fontFamily: "InterBold",fontWeight: FontWeight.w600,color: Colors.white), ),
      ...
      elevatedButtonTheme: ElevatedButtonThemeData(
          style: ElevatedButton.styleFrom(
              ...
              disabledBackgroundColor: Colors.grey,
              disabledForegroundColor: Colors.grey,
              side: const BorderSide(color: darkWidgetColorBackground,strokeAlign: 2),
              textStyle: const TextStyle(fontFamily: "InterBold",fontSize: 16,color: Colors.black,fontWeight: FontWeight.w600)
      ...
      textTheme: const TextTheme().copyWith(
        ...
        titleSmall: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.white),
        labelLarge: const TextStyle().copyWith(fontSize: 15, fontWeight: FontWeight.normal, color: Colors.white),
        labelMedium: const TextStyle().copyWith(fontSize: 14, fontWeight: FontWeight.normal, color: Colors.white),
